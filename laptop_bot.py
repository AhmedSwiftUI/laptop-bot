...
async def about(update: Update, context: ContextTypes.DEFAULT_TYPE):
    text = (
        "💡 توبلاب هو مساعد ذكي يساعدك تختار أفضل لابتوب يناسب ميزانيتك واستخدامك، سواء كنت طالب، مصمم، مبرمج أو جيمر.\n\n"
        ...
        "🎯 هدف توبلاب إنك توصل لأفضل خيار بدون ما تضيع وقتك في المقارنات.\n\n"
        "🧠 كل لابتوب يتم اختياره بناءً على جودة المواصفات، الأداء مقابل السعر، والسمعة العامة للمنتج."
    )
